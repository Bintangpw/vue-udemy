<template>
  ...
  <section>
    ...
    <div>Total Expenses: {{ state.currentExpenses }}</div>
    <hr />
  ...
  <section>
    <form @submit.prevent="addExpense">
      <div>
        ...
        <input id="amount" type="number" v-model="state.enteredExpense" />
      </div>
...
export default {
  ...
  function addExpense() {
    state.currentExpenses += state.enteredExpense;
  }

  const remainingFunds = computed(() => availableFunds - state.currentExpenses);
